...
<div in:fly={{x:200, duration: 400}} class="container-full mx-auto p-3" class:blur-sm={!loadingModal}>
  ...
  <div in:fly={{x:200, duration: 400}} class='flex flex-col justify-center items-center w-full mb-5'>
    ...
    <input type="email" bind:value={email} placeholder="ex: name@work-email.com" class="sm:w-1/2 w-full my-5 p-3 rounded-lg bg-[#ddf0f2]" autofocus/>
    <button 
      class="bg-[#52c0cc] sm:w-1/2 w-full p-3 rounded-lg"
  ...
  {:else if registrationStep === 2}
    <div in:fly={{x:200, duration: 400}} class='flex flex-col justify-center items-center w-full mb-5'>
      ...
      <input type="password" bind:value={password} placeholder="Password" class="sm:w-1/2 w-full my-5 p-3 rounded-lg bg-[#ddf0f2]" autofocus/>
      <button 
      class="bg-[#52c0cc] sm:w-1/2 w-full p-3 rounded-lg" 
    ...
    <div in:fly={{x:200, duration: 400}} class='flex flex-col justify-center items-center w-full mb-5'>
      ...
      <input type="text" bind:value={companyName} placeholder="" class="sm:w-1/2 w-full my-5 p-3 rounded-lg bg-[#ddf0f2]" autofocus />
      ...
      <button class="bg-[#52c0cc] sm:w-1/2 w-full p-3 rounded" on:click|preventDefault={handleDelay}  disabled={!companyName ? true : false}>Finish</button>
    </div>
    {/if}
